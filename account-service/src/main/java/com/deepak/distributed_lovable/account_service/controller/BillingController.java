...
import com.deepak.distributed_lovable.account_service.service.PaymentProcessor;
import com.deepak.distributed_lovable.account_service.service.SubscriptionService;
...
public class BillingController {
    ...
    public ResponseEntity<SubscriptionResponse> getAllSubscriptions(){
        return ResponseEntity.ok(subscriptionService.getCurrentSubscription());
    }

    @PostMapping("/api/payment/checkout")
    public ResponseEntity<CheckoutResponse> createCheckoutResponse(@RequestBody CheckoutRequest request){
        return ResponseEntity.status(HttpStatus.CREATED).body(paymentProcessor.getCheckOutResponse(request));
    }
    ...
    public ResponseEntity<String> handlePaymentsWebhooks(@RequestBody String payload,
